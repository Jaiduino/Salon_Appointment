...
public class IMaleActivity extends AppCompatActivity implements ServicesListAdapter.addId{
...
//        fragmentTransaction.replace(R.id.constraint,fragment).commit();
    ...
    public void addIdListner(Intent intent) {
        Log.e("added data from IMale","addIdListner  "+intent.getSerializableExtra("pid"));
