...
public class CMaleActivity extends AppCompatActivity implements ServicesListAdapter.addId{
...
//        fragmentTransaction.replace(R.id.constraint,fragment).commit();
    ...
    public void addIdListner(Intent intent) {
        Log.e("added data from CMale","addIdListner  "+intent.getSerializableExtra("pid"));
