...
public class FMaleActivity extends AppCompatActivity implements ServicesListAdapter.addId{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_fmale);
...
//        fragmentTransaction.replace(R.id.constraint,fragment).commit();
    ...
    public void addIdListner(Intent intent) {
        Log.e("added data from FMale","addIdListner  "+intent.getSerializableExtra("pid"));
