...
public class BMaleActivity extends AppCompatActivity implements ServicesListAdapter.addId {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_bmale);
    ...
    private void getdata() {
        ...
        new Retrofit.Builder().addConverterFactory(GsonConverterFactory.create())
                .baseUrl(Constant.BASE_URL).build().create(MensServices.class).getservices("C")
...
//        fragmentTransaction.replace(R.id.constraint,fragment).commit();
    ...
    public void addIdListner(Intent intent) {
        Log.e("added data from BMale","addIdListner  "+intent.getSerializableExtra("pid"));
