...
public class HMaleActivity extends AppCompatActivity implements ServicesListAdapter.addId{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_hmale);
...
//        fragmentTransaction.replace(R.id.constraint,fragment).commit();
    ...
    public void addIdListner(Intent intent) {
        Log.e("added data from HMale","addIdListner  "+intent.getSerializableExtra("pid"));
